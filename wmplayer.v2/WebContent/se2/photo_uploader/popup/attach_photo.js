    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/WMPlayer_Pro/imageUpLoad/file_uploader_html5.jsp'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/WMPlayer_Pro/imageUpLoad/file_uploader.jsp',	//샘플 URL입니다.
 	        sCallback : '/WMPlayer_Pro/se2/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
